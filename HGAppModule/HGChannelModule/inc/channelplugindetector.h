#ifndef CHANNELPLUGINDETECTOR_H
#define CHANNELPLUGINDETECTOR_H
...
class ChannelPluginDetector: public PluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.csm.embed.plugin.pluginInterface.1.0")

public:
    explicit ChannelPluginDetector(QObject* parent=nullptr);
...
private:
    HGChannelSetWidget* channelSetW;

private:

};

#endif // CHANNELPLUGINDETECTOR_H