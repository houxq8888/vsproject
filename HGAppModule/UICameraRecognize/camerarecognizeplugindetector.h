#ifndef CAMERARECOGNIZEPLUGINDETECTOR_H
#define CAMERARECOGNIZEPLUGINDETECTOR_H
...
class CameraRecognizePluginDetector: public PluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.csm.embed.plugin.pluginInterface.1.0")

public:
    explicit CameraRecognizePluginDetector(QObject* parent=nullptr);
...
private:
    HGCameraRecognizeWidget* camerarecognizeW;

private:

};

#endif // CAMERARECOGNIZEPLUGINDETECTOR_H