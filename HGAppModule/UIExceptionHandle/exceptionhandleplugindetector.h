#ifndef EXCEPTIONHANDLEPLUGINDETECTOR_H
#define EXCEPTIONHANDLEPLUGINDETECTOR_H
...
class ExceptionHandlePluginDetector: public PluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.csm.embed.plugin.pluginInterface.1.0")

public:
    explicit ExceptionHandlePluginDetector(QObject* parent=nullptr);
...
private:
    HGExceptionHandleWidget* exceptionHandleW;

private:

};

#endif // EXCEPTIONHANDLEPLUGINDETECTOR_H