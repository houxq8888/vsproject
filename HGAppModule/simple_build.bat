...
REM Run CMake configuration for simplified HGAppModule build
echo Debug: Running CMake configuration for simplified HGAppModule build...
...
echo ===============================================
echo HGAppModule build successful!
echo ===============================================
