#ifndef SEARCHPLUGINDETECTOR_H
#define SEARCHPLUGINDETECTOR_H
...
class SearchPluginDetector: public PluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.csm.embed.plugin.pluginInterface.1.0")

public:
    explicit SearchPluginDetector(QObject* parent=nullptr);
...
private:
    HGInputSearchConditionWidget* searchConditionW;

private:

};

#endif // SEARCHPLUGINDETECTOR_H