#ifndef EBALANCEPLUGINDETECTOR_H
#define EBALANCEPLUGINDETECTOR_H
...
class EbalancePluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit EbalancePluginDetector(QObject* parent=nullptr);
...
private:
    HGEBalanceWidget* ebalanceW;

private:

};

#endif // EBALANCEPLUGINDETECTOR_H