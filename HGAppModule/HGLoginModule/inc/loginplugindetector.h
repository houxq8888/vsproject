#ifndef LOGINPLUGINDETECTOR_H
#define LOGINPLUGINDETECTOR_H
...
class LoginPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit LoginPluginDetector(QObject* parent=nullptr);
...
private:
    HGLoginWidget* loginW;

private:

};

#endif // LOGINPLUGINDETECTOR_H