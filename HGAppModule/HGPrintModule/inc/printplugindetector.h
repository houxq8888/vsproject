#ifndef PRINTPLUGINDETECTOR_H
#define PRINTPLUGINDETECTOR_H
...
class PrintPluginDetector: public PluginInterface
{
    Q_OBJECT
    Q_PLUGIN_METADATA(IID "org.csm.embed.plugin.pluginInterface.1.0")

public:
    explicit PrintPluginDetector(QObject* parent=nullptr);
...
private:
    HGPrintWidget* printW;

private:

};

#endif // PRINTPLUGINDETECTOR_H