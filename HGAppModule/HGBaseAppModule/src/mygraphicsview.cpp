...
{
    qDebug() << "MyGraphicsView::getSelectROI - currentRectItem:" << (void*)currentRectItem << ", scene:" << this->scene();
...
{
    qDebug() << "MyGraphicsView::clearRectItem - Starting, currentRectItem:" << (void*)currentRectItem << ", scene:" << this->scene();
