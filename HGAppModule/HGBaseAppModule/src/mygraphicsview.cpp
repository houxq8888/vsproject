...
{
    qDebug() << "MyGraphicsView::getSelectROI - currentRectItem:" << reinterpret_cast<quintptr>(currentRectItem) << ", scene:" << reinterpret_cast<quintptr>(this->scene());
...
{
    qDebug() << "MyGraphicsView::clearRectItem - Starting, currentRectItem:" << reinterpret_cast<quintptr>(currentRectItem) << ", scene:" << reinterpret_cast<quintptr>(this->scene());
