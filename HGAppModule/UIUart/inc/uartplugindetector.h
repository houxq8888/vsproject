#ifndef UARTPLUGINDETECTOR_H
#define UARTPLUGINDETECTOR_H
...
class UartPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit UartPluginDetector(QObject* parent=nullptr);
