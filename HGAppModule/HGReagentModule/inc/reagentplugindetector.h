#ifndef REAGENTPLUGINDETECTOR_H
#define REAGENTPLUGINDETECTOR_H
...
class ReagentPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit ReagentPluginDetector(QObject* parent=nullptr);
...
private:
    HGReagentManageWidget* reagentManageW;

private:

};

#endif // REAGENTPLUGINDETECTOR_H