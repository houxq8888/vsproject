...
#include "../../../HGLogModule/inc/logplugindetector.h"
...
namespace {
struct qt_meta_tag_ZN17LogPluginDetectorE_t {};
} // unnamed namespace

template <> constexpr inline auto LogPluginDetector::qt_create_metaobjectdata<qt_meta_tag_ZN17LogPluginDetectorE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<LogPluginDetector, qt_meta_tag_ZN17LogPluginDetectorE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject LogPluginDetector::staticMetaObject = { {
    QMetaObject::SuperData::link<PluginInterface::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17LogPluginDetectorE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17LogPluginDetectorE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN17LogPluginDetectorE_t>.metaTypes,
    nullptr
} };
...
void LogPluginDetector::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LogPluginDetector::*)(QString , QString , QString )>(_a, &LogPluginDetector::sendMsg2Manager, 0))
            return;
    }
}
...
void *LogPluginDetector::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17LogPluginDetectorE_t>.strings))
...
static constexpr unsigned char qt_pluginMetaDataV2_LogPluginDetector[] = {
    0xbf, 
    // "IID"
...
QT_MOC_EXPORT_PLUGIN_V2(LogPluginDetector, LogPluginDetector, qt_pluginMetaDataV2_LogPluginDetector)
#else
QT_PLUGIN_METADATA_SECTION
Q_CONSTINIT static constexpr unsigned char qt_pluginMetaData_LogPluginDetector[] = {
    'Q', 'T', 'M', 'E', 'T', 'A', 'D', 'A', 'T', 'A', ' ', '!',
