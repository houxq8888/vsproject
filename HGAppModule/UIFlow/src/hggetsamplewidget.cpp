...
bool HGGetSampleWidget::closeWindow(){
    if (m_manipulateW){
...
void HGGetSampleWidget::setMode(){
...
std::string HGGetSampleWidget::getParamStr(){
...
void HGGetSampleWidget::setParamStr(std::string param){
