#ifndef FLOWPLUGINDETECTOR_H
#define FLOWPLUGINDETECTOR_H
...
class FlowPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit FlowPluginDetector(QObject* parent=nullptr);
