#ifndef USERAUDITPLUGINDETECTOR_H
#define USERAUDITPLUGINDETECTOR_H
...
class UserAuditPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit UserAuditPluginDetector(QObject* parent=nullptr);
...
private:
    AuthorityWidget* authorityW;

private:

};

#endif // USERAUDITPLUGINDETECTOR_H