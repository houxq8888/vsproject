#ifndef LOGPLUGINDETECTOR_H
#define LOGPLUGINDETECTOR_H
...
class LogPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit LogPluginDetector(QObject* parent=nullptr);
