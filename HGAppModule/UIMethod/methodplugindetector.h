#ifndef METHODPLUGINDETECTOR_H
#define METHODPLUGINDETECTOR_H
...
class MethodPluginDetector: public PluginInterface
{
    Q_OBJECT
...
public:
    explicit MethodPluginDetector(QObject* parent=nullptr);
...
private:
    HGMethodManageWidget* methodManageW;

private:

};

#endif // METHODPLUGINDETECTOR_H