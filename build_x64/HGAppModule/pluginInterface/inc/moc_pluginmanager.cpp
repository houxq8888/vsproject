...
#include <memory>
#include "../../../../HGAppModule/pluginInterface/inc/pluginmanager.h"
...
QT_MOC_LITERAL(2, 31, 0) // ""
    ...
    "PluginManager\0recMsgfromPlugin\0"
};
...
void PluginManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->recMsgfromPlugin((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2])),(*reinterpret_cast< QString(*)>(_a[3]))); break;
        default: ;
        }
    }
}
