...
#include <memory>
#include "../../../../HGAppModule/HGBaseAppModule/inc/basewidget.h"
...
QT_MOC_LITERAL(1, 11, 17), // "signalSoundVolumn"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14), // "updateLanguage"
QT_MOC_LITERAL(4, 45, 11) // "std::string"

    },
    "BaseWidget\0signalSoundVolumn\0\0"
    "updateLanguage\0std::string"
};
...
void BaseWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->signalSoundVolumn((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updateLanguage((*reinterpret_cast< std::string(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseWidget::signalSoundVolumn)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (BaseWidget::*)(std::string );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&BaseWidget::updateLanguage)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void BaseWidget::signalSoundVolumn(int _t1)
{
...
// SIGNAL 1
void BaseWidget::updateLanguage(std::string _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
